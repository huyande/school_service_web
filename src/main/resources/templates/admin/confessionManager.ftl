...
<html>
	...
	<body>
						...
						<div class="row">
	                      ...
	                      <div class="col-lg-3">
	                          <section class="panel">
	                              ...
	                              <div class="panel-body">
	                                  <div id="conf_male" class="graph"></div>
	                              </div>
	                          </section>
	                      </div>
	                      ...
	                      <div class="col-lg-3">
	                          <section class="panel">
	                              ...
	                              <div class="panel-body">
	                                  <div id="conf_real" class="graph"></div>
	                              </div>
	                          </section>
	                      </div>
                  </div>
				...
				<div class="row">
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="adv-table">
									<table class="display table table-bordered" id="confess-table-info">
										<thead>
											<tr>
												<th>发布者头像</th>
												<th>发布者昵称</th>
												<th>ToUser</th>
												<th class="hidden-phone">点赞数量</th>
		...
		<!--表白管理表格-->
		<script src="${ctx}/js/schconfess_table_init.js"></script>

		<!--common script for all pages-->
		<script src="${ctx}/js/common-scripts.js"></script>
		
		<!-- 创建图表的js -->
   		<script src="${ctx}/js/schconfess_morris-script.js"></script>
